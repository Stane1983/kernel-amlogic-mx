...
extern Lcd_Config_t m6g17_m60_lcd_config;
...
Lcd_Config_t m6g17_m60_lcd_config = {
    .lcd_basic = {
        .h_active = H_ACTIVE,
        .v_active = V_ACTIVE,
        .h_period = H_PERIOD,
...
static struct aml_bl_platform_data m6g17_m60_backlight_data =
{
...
static struct platform_device m6g17_m60_backlight_device = {
    .name = "aml-bl",
    .id = -1,
    .num_resources = 0,
    .resource = NULL,
    .dev = {
        .platform_data = &m6g17_m60_backlight_data,
    },
};

static struct aml_lcd_platform __initdata m6g17_m60_lcd_data = {
    .lcd_conf = &m6g17_m60_lcd_config,
};

static struct platform_device __initdata * m6g17_m60_lcd_devices[] = {
    &meson_device_lcd,
//    &meson_device_vout,
    &m6g17_m60_backlight_device,
};


int m6_m60_lcd_init(void)
{
    int err;
	printk("\nload panel model: %s\n", PANEL_MODEL);
	lcd_tcon_config(&m6g17_m60_lcd_config);
	lcd_setup_gamma_table(&m6g17_m60_lcd_config);
	lcd_video_adjust(&m6g17_m60_lcd_config);	
    meson_lcd_set_platdata(&m6g17_m60_lcd_data, sizeof(struct aml_lcd_platform));
    err = platform_add_devices(m6g17_m60_lcd_devices, ARRAY_SIZE(m6g17_m60_lcd_devices));
    return err;
}
