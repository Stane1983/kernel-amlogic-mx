/*
 * customer/boards/board-m6g18-dbxmx.c
 *
...
/***********************************************************************
 * WIFI  Section / Card Reader Section
 **********************************************************************/
...
static struct resource ite9173_resource[]  = {
	...
	[4] = {
		.start = PAD_GPIOB_21, //TUNER_POWERC pin
		.end   = PAD_GPIOB_21,
		.flags = IORESOURCE_MEM,
		.name  = "frontend0_TUNER_POWER"
	},
	[5] = {
		.start = PAD_GPIOB_20, //ANT_OVERLOAD pin
		.end   = PAD_GPIOB_20,
		.flags = IORESOURCE_MEM,
		.name  = "frontend0_ANT_OVERLOAD"
	},
	[6] = {
		.start = PAD_GPIOB_23, //ANT_POWER pin
		.end   = PAD_GPIOB_23,
		.flags = IORESOURCE_MEM,
...
#ifndef CONFIG_MESON_XBMC_BUILD
MACHINE_START(MESON6_G02, "Amlogic based DroidBOX MX")
...
MACHINE_END
#else
MACHINE_START(MESON6_G02, "DroidBOX MX")
    .boot_params    = BOOT_PARAMS_OFFSET,
    .map_io         = meson_map_io, //2
    .init_early     = meson_init_early, //3
    .init_irq       = meson_init_irq, //0
